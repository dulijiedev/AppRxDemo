package com.dol.appupdate.manager;
...
import com.dol.appupdate.dialog.UpdateDialog;
import com.dol.appupdate.listener.OnCompareUpdate;
...
public class DownloadManager {
     ...
     * 将比较器放进去
     */
    public void download(boolean compareUpdate) {
//        if (!checkParams()) {
//            //参数设置出错....
//            return;
//        }
